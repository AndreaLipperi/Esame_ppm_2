...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '192.168.1.60', '172.20.10.2', '.vercel.app', '*']  # Aggiungi il tuo indirizzo IP
...
GLOBAL_VARIABLE = '' #variabile globale ceh conterrà l'username dell'utente che userà il programma
# Password validation
